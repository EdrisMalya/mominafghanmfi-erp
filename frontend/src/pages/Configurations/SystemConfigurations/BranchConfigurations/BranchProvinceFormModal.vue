    ...
    methods: {
        async handleSubmit(values, actions) {
            ...
            try {
                ...
                const url = this.data
                    ? `configurations/system-configurations/branch-province/${this.data?.id}`
                    : 'configurations/system-configurations/branch-province/'
